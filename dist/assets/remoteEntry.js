const currentImports = {};
      ...
      let moduleMap = {
"./LikeButton":()=>{
      dynamicLoadingCss([], false, './LikeButton');
      return __federation_import('./__federation_expose_LikeButton-Du8hu8Y9.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
